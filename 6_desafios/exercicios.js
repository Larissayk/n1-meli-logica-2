// 1 - Utilizando uma estrutura de repetição diferente da que utilizou ontem, crie um programa para printar
...
// Enquanto usuário digitar qualquer palavra, print o que ele está digitando mas avise que para sair ele
//pode dizer "Tchau".
...
// 4 - Utilizando uma estrutura de repetição diferente da que utilizou ontem, crie um  programa contador de 
// passos que acumule os valores de passos informados pelo usuário até que a meta seja atingida.
...
// for(; passos<=meta; ){
//     passos += parseInt(readline.question("Informe a quantidade de passos: "));
// }
// console.log(`Parabéns! Vc bateu sua meta! ${passos}passos`);
